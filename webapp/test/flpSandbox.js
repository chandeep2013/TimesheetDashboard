		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#commgctsdashboarduatui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commgctsdashboarduatui-display": {
								"semanticObject": "commgctsdashboarduatui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mgc.tsdashboarduatui",
									"url": sap.ui.require.toUrl("com/mgc/tsdashboarduatui")
								}
							}
						}
					}
